...
export class MenuService {
  ...
  private _ingredients: IngredientMenuType[] = [
    // Pizza
    {name: 'Aceitunas', price: 40},
    {name: 'Ají', price: 40},
    {name: 'Ajo', price: 40},
    {name: 'Alcachofas', price: 40},
    {name: 'Alcaparras', price: 40},
    {name: 'Anchoa', price: 100},
    {name: 'Atún', price: 90},
    {name: 'Basilico', price: 40},
    {name: 'Berenjena', price: 40},
    {name: 'Camarones', price: 150},
    {name: 'Carne molida', price: 90},
    {name: 'Cebolla', price: 40},
    {name: 'Chorizo', price: 90},
    {name: 'Crema de leche', price: 30},
    {name: 'Gorgonzola', price: 90},
    {name: 'Grana', price: 40},
    {name: 'Hongos', price: 40},
    {name: 'Huevo', price: 30},
    {name: 'Jamón', price: 90},
    {name: 'Jamón serrano', price: 150},
    {name: 'Lechuga', price: 40},
    {name: 'Maíz', price: 40},
    {name: 'Mescla de mariscos', price: 180},
    {name: 'Miel', price: 40},
    ...
    {name: 'Perejil', price: 0},
    {name: 'Pepino', price: 40},
    {name: 'Piña', price: 40},
    {name: 'Pollo', price: 90},
    {name: 'Romero', price: 40},
    {name: 'Roquefort', price: 90},
    {name: 'Rúcula', price: 40},
    {name: 'Tocineta', price: 90},
    {name: 'Tomate', price: 40},
    // Pasta
    {name: 'Aceitunas', price: 40},
    {name: 'Ají', price: 40},
    {name: 'Ajo', price: 40},
